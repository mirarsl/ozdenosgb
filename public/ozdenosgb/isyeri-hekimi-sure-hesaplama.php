...
<head>
	...
	<link rel="canonical" href="http://www.ozdenosgb.com/isyeri-hekimi-sure-hesaplama" />
	
	<title>İşyeri Hekimi Süre Hesaplama » Özden OSGB</title>
	<meta name="description" content="Ayda kaç saat işyeri hekimi hizmeti almanız gerektiğini, Özden OSGB'nin hazırladığı hesaplama aracını kullanarak hesaplayın."/>
...
<body>
	...
	<div class="page-image-header">
		<div class="container">
			<h1>HEKİM ÇALIŞMA SÜRESİ HESAPLAMA</h1>
	...
	<div class="container breadcrumb-container">
		<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
			...
			<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
				<a href="isyeri-hekimi-sure-hesaplama" title="İşyeri Hekimi hizmet süresi hesaplama" itemprop="item">
					<span itemprop="name">İşyeri Hekimi</span>
				</a>
    ...
    <div class="container sure-hesaplama-section">
		<h2>Ayda kaç saat işyeri hekimi hizmeti almanız gerekiyor? Hemen hesaplayın</h2>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="input-group">
                  ...
                  <span class="input-group-btn">
                    <button onclick="sureHesapla2016('hekim');" class="btn btn-success" type="button">Hesapla</button>
                  </span>
                </div>
            </div>
        </div>
		...
		<div class="row" id="hesaplama-result">
            <div class="col-md-8 col-md-offset-2">
                <div class="thumbnail">
                    <div class="row">
                        <div class="col-md-3">
                            <img src="img/osgb/hekim.png" alt="İşyeri Hekimi" class="img-responsive">
                        </div>
                        <div class="col-md-3">
