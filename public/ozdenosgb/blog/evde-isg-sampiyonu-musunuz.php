	...
	<div class="container breadcrumb-container">
		<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
			...
			<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
				<a href="<?php echo $prefix ?>blog/evde-isg-sampiyonu-musunuz" title="10 Soruda Yeni İş Sağlığı ve Güvenliği Kanunu" itemprop="item">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 left-side">
					<div class="thumbnail">
						<img src="<?php echo $prefix ?>img/blog/isg-sampiyonu.jpg" alt="Evde İSG Şampiyonu Kim?" class="img-responsive">
					</div>
				...
				<div class="col-md-8">
					...
					<div id="score_area" style="display: none;">
						...
						<div class="row">
							<div class="col-md-4">
								<img id="up" style="display: none;" src="<?php echo $prefix ?>/img/blog/isgchamp_up.jpg">
								<img id="down" style="display: none;" src="<?php echo $prefix ?>/img/blog/isgchamp_down.jpg">
							</div>
						</div>
					</div>
