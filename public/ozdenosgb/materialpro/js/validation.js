    ...
    var defaults = {
                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("pattern") !== undefined) {
                            message = "Yanlış format<!-- data-validation-pattern-message to override -->";
        ...
        , validatorTypes: {
            ...
            , number: {
                ...
                , message: "Bir rakam girmelisiniz"
            }
        }
        , builtInValidators: {
            email: {
            ...
            , required: {
                name: "Required"
                , type: "required"
                , message: "Zorunlu alan<!-- data-validator-required-message to override -->"
            }
            , checkone: {
                name: "Checkone"
                , type: "minchecked"
