...
<head>
	...
	<link rel="canonical" href="http://www.ozdenosgb.com/saglik-personeli-sure-hesaplama" />
	
	<title>Sağlık Personeli Süre Hesaplama » Özden OSGB</title>
	<meta name="description" content="Ayda kaç saat sağlık personeli (işyeri hemşiresi) hizmeti almanız gerektiğini, Özden OSGB'nin hazırladığı hesaplama aracını kullanarak hesaplayın."/>
...
<body>
	...
	<div class="page-image-header">
		<div class="container">
			<h1>SAĞLIK PERSONELİ ÇALIŞMA SÜRESİ HESAPLAMA</h1>
	...
	<div class="container breadcrumb-container">
		<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
			...
			<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
				<a href="saglik-personeli-sure-hesaplama" title="Sağlık personeli - işyeri hemşiresi hizmet süresi hesaplama" itemprop="item">
					<span itemprop="name">Sağlık Personeli</span>
				</a>
    ...
    <div class="container sure-hesaplama-section">
		<h2>Ayda kaç saat sağlık personeli hizmeti almanız gerekiyor? Hemen hesaplayın</h2>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="input-group">
                  ...
                  <span class="input-group-btn">
                    <button onclick="sureHesapla2016('saglikpersoneli');" class="btn btn-success" type="button">Hesapla</button>
                  </span>
                </div>
            </div>
        </div>
		...
		<div class="row" id="hesaplama-result">
            <div class="col-md-8 col-md-offset-2">
                <div class="thumbnail">
                    <div class="row">
                        <div class="col-md-3">
                            <img src="img/osgb/hemsire.png" alt="Diğer Sağlık Personeli - İşyeri Hemşiresi" class="img-responsive">
                        </div>
                        <div class="col-md-3">
